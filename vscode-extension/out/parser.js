...
class AutomataParser {
    ...
    validateTransitionStructure(transitions, type) {
    ...
    validateSemanticConstraints(json, type) {
    ...
    validateTransitionReferences(transitions, states, alphabet, type, tapeAlphabet) {
            ...
            for (const destination of Object.values(stateTransitions)) {
                switch (automaton.type) {
                    ...
                    case 'nfa':
                        ...
                        break;
                    case 'tm':
                        referenced.add(destination.state);
                        break;
                }
            }
        }
...
exports.AutomataParser = AutomataParser;
